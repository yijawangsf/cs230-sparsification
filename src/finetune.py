...
if __name__ == "__main__":
    ...
    #     "SVHN",
    # ]
    train_datasets = parse_arguments().train_dataset
    epochs = {
        "Cars": 35,
        "DTD": 76,
        "EuroSAT": 12,
    ...
    for dataset in train_datasets:
        ...
        if args.seed is not None:
            args.save = f"{args.checkpoint_dir}/checkpoints_{args.seed}"
        else:
        ...
        print(f"{dataset} run time: {time.time() - tic}")